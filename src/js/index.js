/*
    ...
    OBJETIVO 2 - quando passar o mouse em cima do personagem na listagem, trocar a imagem, o nome e a descrição do personagem grande
        1 - pegar o elemento do personagem grande pra adicionar as informações nele
        2 - alterar a imagem do personagem grande
...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        ...
        alterarDescicaoPersonagem(personagem);
    })
})
function alterarDescicaoPersonagem(personagem) {
    const textoPersonagem = document.getElementById('descricao-personagem');
    textoPersonagem.innerText = personagem.getAttribute('data-description');
}
